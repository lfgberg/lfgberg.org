...
tags: ["CTF", "Writeup", "AD"]
---
![Baby Thumbnail](ctfs/vulnlab/vl-baby.png)
...
![SMB Password Spray](ctfs/vulnlab/cme-smb-passwd-spray.png)
...
![User Flag](ctfs/vulnlab/user-flag.png)
...
![Initial Permissions](ctfs/vulnlab/initial-privs.png)
...
![Local Hashes](ctfs/vulnlab/local-creds.png)
...
![Root Flag](ctfs/vulnlab/root-flag.png)
